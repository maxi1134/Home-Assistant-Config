...
- **AI Event Summary (v1.4.3) (Front and Back Door)** — **Automation ID:** `1751133520036`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Alert if someone is loitering by the car for too long** — **Automation ID:** `1743004781903`
...
- **Alert if the front door remains unlocked for too long** — **Automation ID:** `1731345211107`
...
- **Alert maxi if someone comes in while he is sleeping** — **Automation ID:** `1717038269264`
...
- **Alert maxi if someone enters his room while alarm is set to armed home** — **Automation ID:** `1729698938654`
...
- **alert maxi if someone goes into the hotbox during a party** — **Automation ID:** `1737850261149`
...
- **Alert Maxi when the automatic back horn is disabled** — **Automation ID:** `1747075531283`
...
- **Alert people in the back to go away** — **Automation ID:** `1727032753670`
...
- **Alert that the front door remained open** — **Automation ID:** `1713378916074`
...
- **Alert when back horns rings and offer to turn it off** — **Automation ID:** `1743281098829`
...
- **Alert when parking siren goes on and offer to turn it off** — **Automation ID:** `1760287140341`
...
- **Alert when someone is in the back (old)** — **Automation ID:** `1717016815299`
...
- **Alert when someone is in the back (Reolink)** — **Automation ID:** `1744811754806`
...
- **Alert when someone is in the parking** — **Automation ID:** `1743179648448`
...
- **Alert when the horn goes off and offer to turn it off** — **Automation ID:** `1716935540936`
...
- **Alert when there is motion inside during arm away and trigger alarm** — **Automation ID:** `1717354512446`
...
- **Analyze person in the parking when car is present to detect burglary** — **Automation ID:** `1742998769189`
...
- **Arm Alarm-Away when "User home" is off for 10 minutes** — **Automation ID:** `1713533768680`
...
- **Arm night alarm when everyone is sleeping** — **Automation ID:** `1717284487763`
...
- **Assist Show cameras on TVs** — **Automation ID:** `1730428380200`
...
- **Auto-lock doors when closed for 5 seconds** — **Automation ID:** `1713378517441`
...
- **Automatically turn back door light back off** — **Automation ID:** `1735346521960`
...
- **Automatically turn off Back door light when there is no motion** — **Automation ID:** `1744811669242`
...
- **Automatically turn off the back security horn after 2 minutes and ask if it should restart** — **Automation ID:** `1717016954049`
...
- **Automatically turn off the front security horn after 2 minutes and ask if it should restart** — **Automation ID:** `1716933958613`
...
- **Back door floodlight auto-mode on sunset, off on sunrise** — **Automation ID:** `1744811034444`
...
- **Back lock automation on main codes** — **Automation ID:** `1749940499172`
...
- **Control brightness of Front door Phone to avoid discharge** — **Automation ID:** `1740690697244`
...
- **Disable automatic back horn when Alarm system is disarmed ** — **Automation ID:** `1748329710904`
  Triggered when `alarm_control_panel.home_alarm` changes to `disarmed`. Actions: turn off `input_boolean.maxi_is_scared`.

- **Disable automatic back horn when lylou awakes between 7:45 and 8:45** — **Automation ID:** `1758115238753`
...
- **Disable automatic back horn when myriam awakes** — **Automation ID:** `1750625732180`
...
- **Disable Automatic Back Horn when resident arrives** — **Automation ID:** `1747074693573`
...
- **Disarm alarm night when someone awakes** — **Automation ID:** `1717284510591`
...
- **Disarm alarm when sun rises if everyone present is awake** — **Automation ID:** `1760963671925`
...
- **Disarm alarm-away when "User Home" turns on** — **Automation ID:** `1713533595890`
...
- **Doorbell Main automation** — **Automation ID:** `1715717946486`
...
- **Doorbell Show received notification answer on phone** — **Automation ID:** `1715791112355`
...
- **Enable automatic Back Door Horn when Lylou is alone** — **Automation ID:** `1748287626823`
  Triggered when `binary_sensor.lylou_alone` changes from `off` to `on` for 10m. Actions: turn on `input_boolean.maxi_is_scared`.

- **FRigate Arriving only Notification** — **Automation ID:** `1752001220545`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Frigate back Doors Notifications ** — **Automation ID:** `1744744086412`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Frigate front Doors Notifications ** — **Automation ID:** `1745468097447`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Frigate Parking notifications** — **Automation ID:** `1745467773993`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Front door automation on unlock for conditional codes** — **Automation ID:** `1729519649402`
...
- **Front door automation on unlock for main codes** — **Automation ID:** `1723214966525`
...
- **Lock tablets on triggered alarm** — **Automation ID:** `1717360188815`
...
- **Lower volume if police is detected in the front during a party** — **Automation ID:** `1732406375683`
...
- **Notify on potential package** — **Automation ID:** `1716329212232`
...
- **Notify when someone leaves through front door** — **Automation ID:** `1729698675763`
...
- **Post-alarm disarm recovery actions** — **Automation ID:** `1717356233481`
...
- **Re-lock doors 5 minutes after unlocking if door is shut** — **Automation ID:** `1713378679048`
...
- **Reload tablets when frigate changes state** — **Automation ID:** `1714405984049`
...
- **Reset doorbell stuff on unlock** — **Automation ID:** `1715719948033`
...
- **Return PTZ to doorway after 10 minutes** — **Automation ID:** `1751650700641`
  Triggered when event `call_service`. Actions: wait 10m; set option on `select.front_door_ptz_camera_ptz_preset` (option='Doorway').

- **Ring horn in the back if someone tries to approach while maxi is scared** — **Automation ID:** `1743747879302`
...
- **Ring parking horn on actionnable notification from mobile** — **Automation ID:** `1760286041191`
...
- **Set front door screen text** — **Automation ID:** `1717038729859`
...
- **Start turning lights on before maxi's alarm rings on week days for work** — **Automation ID:** `1766609371758`
...
- **Toggle parking audio detection based on patio occupancy** — **Automation ID:** `1744572056958`
...
- **Trigger back horn when someone loiters for too long at the door** — **Automation ID:** `1731941986104`
...
- **Trigger front horn through phone notification** — **Automation ID:** `1717355583664`
...
- **Trigger in-home defense script after the alarm is triggered for 3 continuous minutes** — **Automation ID:** `1717358289455`
...
- **Trigger police announcement on triggered alarm** — **Automation ID:** `1717358415139`
...
- **Turn back door lights on when someone is detected** — **Automation ID:** `1713408006382`
...
- **Turn camera to doorway on doorbell action** — **Automation ID:** `1716912930623`
...
- **Turn off Back camera siren when back horn goes off** — **Automation ID:** `1747066080524`
  Triggered when `switch.plug_back_door_horn` changes from `on` to `off`. Actions: turn off `siren.reolink_back_door_camera_siren`.

- **Turn off back horn when maxi is scared is disabled** — **Automation ID:** `1747367207590`
...
- **Turn off cameras on screens when door is locked back** — **Automation ID:** `1757350225543`
...
- **Turn off front door screen if it remains open 10 minutes** — **Automation ID:** `1740757033954`
...
- **Turn off front door screen on clear of occupancy** — **Automation ID:** `1740691064559`
...
- **Turn off Maxi is Scared when all residents sleeping turns off during daytime** — **Automation ID:** `1747634049446`
...
- **Turn off parking light 5 minutes after it turns on if there's no person presence** — **Automation ID:** `1744235712389`
...
- **Turn off Parking light on 5 minutes of no occupancy** — **Automation ID:** `1742862955443`
...
- **Turn off the front door light in relation to the sun position** — **Automation ID:** `1729518874101`
  Triggered when `sun.sun` changes to `above_horizon` for 15m. Actions: turn off `light.front_door_light` (transition=300).

- **Turn on Automatic back Horn upon receiving notification answer** — **Automation ID:** `1747075906852`
...
- **Turn on back door light when door opens** — **Automation ID:** `1743954245142`
...
- **Turn on back door light when resident arrives through parking** — **Automation ID:** `1749955882836`
...
- **Turn on camera floodlight when someone is detected and maxi is scared is on** — **Automation ID:** `1744810927278`
...
- **Turn on front door screen on occupancy** — **Automation ID:** `1740691034464`
...
- **Turn on Maxi is scared upon alarm arming away** — **Automation ID:** `1747705240902`
...
- **Turn on Maxi is scared when Alarm is armed night** — **Automation ID:** `1752029259001`
...
- **Turn on Maxi is scared when All Residents are sleeping** — **Automation ID:** `1747633994244`
...
- **Turn on Parking Infrared when Parking Exit infrared goes off** — **Automation ID:** `1745368052673`
...
- **Turn on parking light on any parking/balcony activity** — **Automation ID:** `1742862883906`
...
- **Turn on the front door light in relation to the sun position** — **Automation ID:** `1733789430500`
...
- **Unlock tablets on disarmed alarm** — **Automation ID:** `1717360231281`
...
- **Add playing Spotify or tidal artist to Lidarr** — **Automation ID:** `1757814887686`
...
- **Adjust all player speakers volume when myriam arrives** — **Automation ID:** `1750445618240`
...
- **Adjust Chromecast volume when unmuted after a long moment** — **Automation ID:** `1749001900174`
...
- **Automatically adjust bathroom volume on unmute** — **Automation ID:** `1767744894962`
...
- **Automatically turn off TVs** — **Automation ID:** `1716328766276`
...
- **Conditionally Unmute Speakers when a room is occupied** — **Automation ID:** `1713719722990`
...
- **Control volume of kitchen to prevent noise in children room while she sleeps** — **Automation ID:** `1748845695784`
...
- **Enable Following Music When all residents sleeping goes to ON after being OFF for over 1hour** — **Automation ID:** `1748225477514`
...
- **Immediately mute bathroom speaker when door open and stuff is playing around** — **Automation ID:** `1744750478317`
...
- **Immediately mute bathroom speaker when door open if all residents are sleeping** — **Automation ID:** `1748939696079`
...
- **Lower loud volume when someone exits the shower** — **Automation ID:** `1757892274893`
...
- **Lower sound when assist in progress** — **Automation ID:** `1727112478403`
...
- **Music Assistant - Local(only) Voice Support Blueprint** — **Automation ID:** `1753133885395`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Mute Bathroom Speaker Muzak v3** — **Automation ID:** `1767743397238`
...
- **Mute bathroom speaker when door opens** — **Automation ID:** `1734911416848`
...
- **Mute bathroom speaker when no motion and door open** — **Automation ID:** `1738094823714`
...
- **Mute chromecasts when they play PLEX visuals** — **Automation ID:** `1714150045572`
...
- **Mute Chromecasts when unmuted speakers plays in the same room** — **Automation ID:** `1748932635965`
...
- **Mute speaker in room if Myriam receives or makes call** — **Automation ID:** `1750025216771`
...
- **Mute speakers in rooms if myriam enters while talking ** — **Automation ID:** `1757437097586`
...
- **Mute speakers in the room if maxi uses a microphone** — **Automation ID:** `1714321256821`
...
- **Mute speakers when the room is empty** — **Automation ID:** `1713826329670`
...
- **Mute speakers when unmuted chromecast plays in the same room** — **Automation ID:** `1714403972538`
...
- **Play Muzak in the bathroom when someone enters** — **Automation ID:** `1713535684569`
...
- **Play Random Music when maxi awakes at home** — **Automation ID:** `1708472009602`
...
- **Raise music on the playing speaker when the Bathroom fans goes on** — **Automation ID:** `1713536409397`
...
- **Raise volume of speakers in a room when the vacuum is cleaning it** — **Automation ID:** `1753986114116`
...
- **Replace Spotify with Muzak playlist after 3.5 minutes** — **Automation ID:** `1747558481492`
...
- **Set the kitchen hub volume to 100% on app launch** — **Automation ID:** `1738201829040`
...
- **Skips song's myriam don't like whe she is home** — **Automation ID:** `1749235496765`
...
- **Speaker Automatic Volume v4** — **Automation ID:** `1737729890470`
...
- **Start bathroom muzak when door closes** — **Automation ID:** `1744750292983`
...
- **Start music when maxi returns home** — **Automation ID:** `1741877702709`
...
- **Start rain sounds where maxi is sleeping** — **Automation ID:** `1717285150530`
...
- **Start visuals on all inactive TVs** — **Automation ID:** `1713723493265`
  Triggered when `input_button.start_visuals` changes. Actions: run `script.start_visual_playlist_on_plex`.

- **Stop bedroom speaker when bedroom sleeper awake** — **Automation ID:** `1708472370553`
...
- **Stop home group when maxi leaves** — **Automation ID:** `1751674442304`
...
- **Stop thunderstorm sound when bedroom awakes** — **Automation ID:** `1749266986349`
...
- **Trigger initial Speaker volume script when Following Music turns on** — **Automation ID:** `1748032160039`
...
- **Turn off Jukebox Access during Live Concert** — **Automation ID:** `1761366615315`
...
- **Turn off speakers after 15 minutes of pause** — **Automation ID:** `1714151063007`
...
- **Turn on Jukebox Public queue when party mode turns on** — **Automation ID:** `1759518333967`
...
- **Turn on volume control automations when Following speakers goes to on** — **Automation ID:** `1748225209386`
...
- **Unmute Bathroom Muzak on Door Close** — **Automation ID:** `1774308533764`
...
- **UnMute chromecasts when no unmuted speakers in the same room** — **Automation ID:** `1748927820689`
...
- **Unmute playing bathroom speaker when someone enters** — **Automation ID:** `1743452959837`
...
- **UnMute speakers when no unmuted chromecast in the same room** — **Automation ID:** `1748928181744`
...
- ** Trippy Light Random Colors Effect automation (Script call)** — **Automation ID:** `1774297006546`
...
- **Automatically turn off bathroom light** — **Automation ID:** `1740935035535`
...
- **Avoid trippy lights dual activation** — **Automation ID:** `1766790345547`
...
- **Bedroom Hue Dial Automation** — **Automation ID:** `1749521213239`
...
- **Bedroom hue tap remote automation ** — **Automation ID:** `1721278758149`
...
- **Dial Bedroom automation** — **Automation ID:** `1763156136004`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial hallway automation new** — **Automation ID:** `1772565586854`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Kitchen Automation New** — **Automation ID:** `1752639024754`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Lounge Automation New** — **Automation ID:** `1752639270370`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Lounge Tree Automation New** — **Automation ID:** `1756568623181`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Salon Automation New** — **Automation ID:** `1752638710619`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Salon window Automation New** — **Automation ID:** `1752638946576`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Workshop Automation New** — **Automation ID:** `1752638811178`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dial Workshop Wall Automation New** — **Automation ID:** `1752638839619`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

- **Dim budha if someone is watching TV in salon from bed** — **Automation ID:** `1769570875542`
...
- **Dim Wall lights when workshop TV is playing and Beige couch or matress is occupied** — **Automation ID:** `1728311156670`
...
- **execute Sleep actions when "sleeper in bedroom" is turned on** — **Automation ID:** `1748845278340`
...
- **Execute sleep actions when "Sleeper in closet" turns on** — **Automation ID:** `1740935638351`
...
- **Hallway hue dial automation** — **Automation ID:** `1763655791601`
...
- **Hotbox Hue Dial Automation** — **Automation ID:** `1763157128192`
...
- **Hue Dial lounge automation** — **Automation ID:** `1763653396906`
...
- **Kitchen hue dial automation** — **Automation ID:** `1763657214344`
...
- **Lower lights to 30% when a movie is played** — **Automation ID:** `1752801417034`
...
- **Nanoleaf actions control automation** — **Automation ID:** `1773975525008`
...
- **Partial sleep actions in hotbox when Lylou falls asleep** — **Automation ID:** `1756344417569`
...
- **Raise lights to 60% brightness when a movie is paused and the brightness is below 30%** — **Automation ID:** `1713630060902`
...
- **Remote Phillip Dimmer Automation** — **Automation ID:** `1753137946773`
...
- **revert Lounge Door Arch effect to solid color when All residents Present Sleeping is on for 4 hours** — **Automation ID:** `1754715205053`
...
- **Salon hue dial automation** — **Automation ID:** `1763657573280`
...
- **Set Wallpaper engine colors to match the lights** — **Automation ID:** `1733790164217`
...
- **Sleep actions when "sleeper in hotbox" is turned on** — **Automation ID:** `1739631004694`
...
- **Sleep actions when "sleeper in patio" is turned on** — **Automation ID:** `1731515407976`
...
- **Sleeper actions when salon sleeper turns on** — **Automation ID:** `1749333714992`
...
- **Trippy Light Warm Random Colors Effect automation (Script call)** — **Automation ID:** `1774297474995`
...
- **Turn Assist screens on when listening** — **Automation ID:** `1728390311720`
...
- **Turn light on when someone is detected in the front** — **Automation ID:** `1714688757969`
...
- **Turn lights back to normal when UV lamps are turned off** — **Automation ID:** `1754680196397`
...
- **Turn lights to white when we stop a movie** — **Automation ID:** `1713574201448`
...
- **Turn off 'Sleeper in X' switch when lights are on and bright in the room for 7 minutes** — **Automation ID:** `1755459606104`
...
- **Turn off Assists screens when done listening** — **Automation ID:** `1728390398785`
...
- **Turn off lights automatically when room is empty and sleep mode is on** — **Automation ID:** `1753418041554`
...
- **Turn off lights colors adaptation when an event is ongoing** — **Automation ID:** `1714668230697`
...
- **Turn off lights when a room is empty and sleep mode is off V2** — **Automation ID:** `1747973723106`
...
- **Turn off lights when the house is empty** — **Automation ID:** `1714497353040`
  Triggered when `zone.home` goes below `0.9` for 5m. Actions: turn off `light.group_all_inside_lights`.

- **Turn off patio lights at sunset when patio is empty** — **Automation ID:** `1768863734220`
...
- **Turn off sleeper in bedroom when lights turns on** — **Automation ID:** `1717285030468`
...
- **Turn off trippy lights after 16 continous hours** — **Automation ID:** `1766792030896`
...
- **Turn off workshop lights when bedroom Sleeper turns on ** — **Automation ID:** `1723530969899`
...
- **Turn on Blue Light with UV Lamps in Same Area** — **Automation ID:** `1754679794287`
...
- **Turn on color adaptation when events end** — **Automation ID:** `1714668294513`
...
- **Turn on lights automatically** — **Automation ID:** `1713824382107`
...
- **Undim budha lights when movie stops or people raise** — **Automation ID:** `1769570986649`
...
- **unDim Wall lights when workshop TV is stopped ** — **Automation ID:** `1728311332778`
...
- **Undo Sleep actions when "sleeper in bedroom" is turned off** — **Automation ID:** `1748845212701`
...
- **Undo Sleep actions when "sleeper in patio" is turned off** — **Automation ID:** `1731515445191`
...
- **undo Sleeper action in salon when sleeper turns off** — **Automation ID:** `1749333829084`
...
- **Undo sleeper actions when Sleeper in closet turns off** — **Automation ID:** `1740935693012`
...
- **Vibrating color effect automation** — **Automation ID:** `1766817510039`
...
- **Workshop Desk Hue Dial automation** — **Automation ID:** `1763775560173`
...
- **Workshop Hue dial automation** — **Automation ID:** `1763656472816`
...
- **close bedroom blind in relation to bedroom ac** — **Automation ID:** `1748838408630`
...
- **Close salon blind sometimes after sun closes** — **Automation ID:** `1747632525749`
...
- **Close salon blind upon sunset** — **Automation ID:** `1752195988065`
  Triggered when `sun.sun` changes from `above_horizon` to `below_horizon` for 10m. Actions: close `cover.cover_salon_blinds`.

- **Close workshop Blind in relation to AC** — **Automation ID:** `1747682690257`
...
- **Control Bedroom Thermostat in relation to Bedroom sleeper** — **Automation ID:** `1750445065859`
...
- **Isolate front salon when active smoking is present** — **Automation ID:** `1772244438943`
...
- **Open bedroom blind in relation to bedroom ac** — **Automation ID:** `1748750771802`
...
- **Open bedroom covers when the person awakes** — **Automation ID:** `1719366131642`
...
- **Open front salon when smoke is gone** — **Automation ID:** `1772328254331`
...
- **Open Salon Blind in relation to AC** — **Automation ID:** `1747423390465`
...
- **Open workshop blind in relation to AC** — **Automation ID:** `1747682528206`
...
- **Raise volume when the AC starts in a room** — **Automation ID:** `1717287475672`
...
- **Sleep actions when "all resident sleeping" is turned on** — **Automation ID:** `1713451307697`
...
- **Sleep actions when "sleeper in workshop" is turned on** — **Automation ID:** `1728309825943`
...
- **Start bathroom fan when Shower in Usage turns on** — **Automation ID:** `1713536741103`
  Triggered when `binary_sensor.shower_in_usage` changes to `on` for 30s. Actions: turn on `switch.bathroom_fan`.

- **Turn ACs on and Off  depending on house occupancy** — **Automation ID:** `1713534223873`
...
- **Turn down volume when AC goes off** — **Automation ID:** `1717290684944`
...
- **Turn off air purifier in salon when smoke is gone** — **Automation ID:** `1772575096130`
...
- **Turn off Bathroom fan when humidity falls** — **Automation ID:** `1734912412449`
...
- **Turn off Closet fan after 5 minutes of non occupancy** — **Automation ID:** `1713631370622`
...
- **Automatically Turn off sleeper in patio** — **Automation ID:** `1740934578627`
...
- **Disable Sleeper in children room when children leaves** — **Automation ID:** `1748898158918`
...
- **mute patio assistant when people are absent** — **Automation ID:** `1775146849950`
...
- **Toggle sleeper in bedroom on button press** — **Automation ID:** `1749014947859`
  Triggered when `sensor.remote_patio_quiet_button_action` changes to `off`. Actions: toggle `input_boolean.sleeper_in_bedroom`.

- **Trigger party script when party mode turns on** — **Automation ID:** `1739316122149`
  Triggered when `input_boolean.party_mode` changes from `off` to `on`. Actions: run `script.set_whole_house_to_party_ambiance`.

- **Turn off hotbox sleeper when lylou sleeping bayesian turns off** — **Automation ID:** `1757861158274`
...
- **Turn off sleep mode for adaptative lighting when myriam awakes** — **Automation ID:** `1750443660133`
...
- **Turn on Bedroom mirror smart plug when myriam awakes** — **Automation ID:** `1750437590850`
...
- **Turn on party mode when over 5 guests are over** — **Automation ID:** `1713451981404`
...
- **Undo Sleep actions when "sleeper in workshop" is turned off** — **Automation ID:** `1728310438747`
...
- **Unmute patio assistant when people are present** — **Automation ID:** `1775146719220`
...
- **Adjust volume of voice assistants on answering** — **Automation ID:** `1751909529397`
...
- **Assist Equalize volume in the house** — **Automation ID:** `1732990123635`
...
- **Assist identify the device** — **Automation ID:** `1738198899369`
...
- **Assist mute ESP32 endpoints when room is unoccupied** — **Automation ID:** `1734282372322`
...
- **Assist play next song** — **Automation ID:** `1716566146304`
...
- **Assist Play random music** — **Automation ID:** `1727273501229`
...
- **Assist quick color change phrase** — **Automation ID:** `1733533239694`
...
- **Assist Restart Music Assistant** — **Automation ID:** `1711565389493`
...
- **Assist Unmute ESP32 endpoints when room is occupied** — **Automation ID:** `1734282252470`
...
- **Change light to random colors on press** — **Automation ID:** `1714077180427`
...
- **Change light to random pastel colors on press** — **Automation ID:** `1714077215807`
...
- **Mute all voice assistants while a concert is happening** — **Automation ID:** `1761366181983`
...
- **Alert house-wide when there is smoke in the kitchen** — **Automation ID:** `1731611005918`
...
- **Alert maxi in the room where he is when his phone rings** — **Automation ID:** `1740953881544`
...
- **Alert maxi that his laptop battery is low** — **Automation ID:** `1739201293361`
...
- **Alert maxi when people are too noisy on the patio during a party ** — **Automation ID:** `1731514999187`
...
- **Alert myriam when lylou nears home** — **Automation ID:** `1759251903732`
...
- **Notify maxi when myriam arrives at home** — **Automation ID:** `1759251745280`
...
- **Open phone to 911 number when smoke "call 911" notification is pressed** — **Automation ID:** `1735277359392`
...
- **Sleep actions when "maxi is sleeping" is turned on anywhere** — **Automation ID:** `1732291871329`
...
- **Tell maxi about the weather when he awakes** — **Automation ID:** `1715696933725`
...
- **Tell maxi when his watch is charged** — **Automation ID:** `1715788063807`
...
- **Trigger all home defense script through notification** — **Automation ID:** `1717359724027`
...
- **Trigger In home defense script through phone notification** — **Automation ID:** `1717797397935`
...
- **Turn off Phone Bluetooth emitter when maxi leaves home** — **Automation ID:** `1732294106703`
...
- **Turn on Phone Bluetooth emitter when maxi arrives home** — **Automation ID:** `1732294056055`
...
- **Undo sleeping actions for Maxi when he awakes** — **Automation ID:** `1732293937510`
...
- **Adjust Bedroom Tablet brightness to match the lights** — **Automation ID:** `1763283441940`
...
- **Adjust closet tablet screen brightness to match the lights** — **Automation ID:** `1740935205313`
...
- **Adjust hallway tablet screen brightness to match the lights** — **Automation ID:** `1741317422533`
...
- **Adjust Kitchen Tablet brightness to match the lights** — **Automation ID:** `1753302685762`
...
- **Adjust workshop tablet screen brightness to match the lights** — **Automation ID:** `1747973281617`
...
- **Auto close closet tablet screen when someone is sleeping** — **Automation ID:** `1715664801848`
...
- **Control bedroom tablet screen to avoid full discharge** — **Automation ID:** `1765731514294`
...
- **Control closet tablet screen to avoid full discharge** — **Automation ID:** `1765730839407`
...
- **Control Hallway Tablet charging** — **Automation ID:** `1713538197256`
...
- **Control workshop secondary tablet screen to avoid full discharge** — **Automation ID:** `1711648800000`
...
- **Control workshop Tablet charging** — **Automation ID:** `1715103309573`
...
- **Display room color  on TVs when mimiclights mode is triggered** — **Automation ID:** `1729462034192`
...
- **kitchen google display automation** — **Automation ID:** `1733597890338`
...
- **Mute speakers in room when Myriam's tablet starts jellyfin playback** — **Automation ID:** `1751301093156`
...
- **Reload Hallway tablet start URL when occupancy of hallway goes to off for 5  minutes** — **Automation ID:** `1748703259809`
...
- **Reload tablet page when motion is detected in the kitchen** — **Automation ID:** `1717291435116`
...
- **Reload workshop tablet start URL when occupancy of workshop goes to off for 5 minutes** — **Automation ID:** `1748703480244`
...
- **Show main screen when music stops on Hallway tablet** — **Automation ID:** `1730910881566`
...
- **Turn on Listening Chime on assist endpoints when screen turns off** — **Automation ID:** `1752076862818`
...
- **Turns on maintenance mode for all tablets During Live Concert** — **Automation ID:** `1761366394577`
...
- **Update Universal Myriam's Tablet Entity area when it changes room** — **Automation ID:** `1751305945586`
...
- **Workshop Tablet dial automation** — **Automation ID:** `1774748550086`
  No triggers or actions are defined, so this appears to be incomplete or placeholder-like.

## Household Appliances & Utility Alerts (9)

- **Alert that the vacuum is stuck** — **Automation ID:** `1713399927983`
...
- **Alert when Airfryer has finished** — **Automation ID:** `1764891085092`
...
- **Alert when Dishwasher finishes and no one is in the kitchen** — **Automation ID:** `1772205343426`
...
- **Alert when dryer finishes!** — **Automation ID:** `1714054125770`
...
- **Alert when Microwave finishes** — **Automation ID:** `1714058481200`
...
- **Alert when the fridge remains open** — **Automation ID:** `1731610964007`
...
- **Alert when the stove water is boiling.** — **Automation ID:** `1731610772963`
...
- **Alert when Toaster finishes** — **Automation ID:** `1772205443339`
...
- **Alert when Washer finishes** — **Automation ID:** `1714058675432`
...
- **Auto-timeout safety net for temporary input booleans** — **Automation ID:** `1740934326306`
...
- **Reload tablets 4 minutes after HA restarts** — **Automation ID:** `1713813890992`
...
- **Update cloudflare when IP changes** — **Automation ID:** `1743869107759`
...
- **Alert Housewide when Kitchen timer is finished** — **Automation ID:** `1731611467781`
...
- **Hibernate Maxi Desktop when he leaves the Salon for more than 20 minutes** — **Automation ID:** `1748938888873`
...
- **Trigger kinky ambiance script when kinky party turns on** — **Automation ID:** `1739373870986`
  Triggered when `input_boolean.kink_party` changes from `off` to `on`. Actions: run `script.set_whole_house_to_kinky_ambiance`.

- **Trigger psychedelic script when acid mode turns on** — **Automation ID:** `1739373811238`
  Triggered when `input_boolean.acid_time` changes from `off` to `on`. Actions: run `script.set_whole_house_to_acid_time`.

- **Turn off acid time when everyone goes to bed** — **Automation ID:** `1740934084849`
...
- **Turn off Sleeping mode for Adaptative lighting on "all resident sleeping" turns off** — **Automation ID:** `1713451780517`
...
- **Turn on Waiting Pakidge when Intelcom emails me and off when it arrives** — **Automation ID:** `1768062570998`
