...
- [House-Wide](/node-red/README.md#archived-flows):
...
- [Trigger-Based](/node-red/README.md#archived-flows):
...
- [Security/Conditions](/node-red/README.md#archived-flows):
...
- [Carla](/node-red/README.md#archived-flows):
   - Tells Carla to move her car at 8:45 and 9:15 if she is present
- [Fay](/node-red/README.md#archived-flows):
   - Create a calendar event when Fay text me a pending task
- [Back Door](/node-red/README.md#archived-flows):
...
- [Front Door](/node-red/README.md#archived-flows):
...
- [Bathroom](/node-red/README.md#archived-flows):
...
- [Bedroom](/node-red/README.md#archived-flows):
...
- [lounge](/node-red/README.md#archived-flows):
  - Connect the dial to the dial subflow
...
- [Chilling Room](/node-red/README.md#archived-flows):
  - Connect the dial to the dial subflow
  - Set a random effect on the tree when it turns on
- [Closet](/node-red/README.md#archived-flows):
...
- [Kitchen](/node-red/README.md#archived-flows):
   - Connect the dial to the dial subflow
...
- [Hotbox Down](/node-red/README.md#archived-flows):
  - Connect the dial to the dial subflow
...
- [Hotbox Top](/node-red/README.md#archived-flows):
  - Connect the dial to the dial subflow
  ...
  - Automatically recast the Lovelace interface to the nest hub when needed
- [workshop](/node-red/README.md#archived-flows):
  - Adjust volume when the AC turns on and off
  - Slightly open the blinds when the AC turns on
  - Close the blinds when the AC turns off
  - Control blinds through the blind button
...
- [Neighbors](/node-red/README.md#archived-flows):
